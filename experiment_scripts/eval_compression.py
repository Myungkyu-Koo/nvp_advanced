"""
1. Load the compressed latent codes from the saved image files and add them to the decoder.
2. Calculate bpp values.
3. Reconstruct the video from the latent codes, and compute psnr score.
"""
...
def load_compressed_keyframes(params, config, save_path, qscale):
    ...
    # Load compressed latent codes from the image file and add to tmp_content
