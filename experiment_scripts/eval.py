"""
'compression.py' + 'eval_compression.py'
Conducts quantization (w/o HEVC/JPEG compression) and de-quantization of latent codes at once and evaluate psnr.
"""
...
'''Quantize and de-dequantize latent codes at once (w/o saving) for evaluation.'''
